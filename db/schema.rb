...
ActiveRecord::Schema.define(version: 20170412115239) do
  ...
  create_table "assemblies_stockholders", id: false, force: :cascade do |t|
    t.integer "assembly_id",    null: false
    t.integer "stockholder_id", null: false
  end

  add_index "assemblies_stockholders", ["assembly_id"], name: "index_assemblies_stockholders_on_assembly_id"
